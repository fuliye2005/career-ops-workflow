...
- **User Layer (NEVER auto-updated; personalization goes HERE):** `workflow-input/personal-info/personal-info.md`, `workflow-input/jd/`, `workflow-input/photos/`, `cv.md`, `config/profile.yml`, `modes/_profile.md`, `modes/_custom.md`, `article-digest.md`, `portals.yml`, `data/*`, `documents/*`, `reports/*`, `output/*`, `interview-prep/*`
...
- `workflow-input/personal-info/personal-info.md` · `cv.md` (legacy fallback) · `article-digest.md` · `config/profile.yml` · `modes/_profile.md` · `writing-samples/`
